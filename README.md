...
The project involves customer segmentation by product categories using purchase data. I used GMM to dissect the data and categorize the
customer data. Enabling the wholesale distributor to make efficient delivery decisions.
